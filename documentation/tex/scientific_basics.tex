...
\begin{enumerate}
\item $\neg a$ \quad\quad\ represents \quad \textsl{nicht} $a$ 
      \vspace*{-0.2cm}

\item $a \wedge b$ \,\quad\ represents  \quad $a$ \textsl{und} $b$
      \vspace*{-0.2cm}

\item $a \vee b$ \,\quad\ represents \quad $a$ \textsl{oder} $b$
      \vspace*{-0.2cm}

\item $a \rightarrow b$   \quad represents \quad \textsl{wenn} $a$, \textsl{dann} $b$
      \vspace*{-0.2cm}

\item $a \leftrightarrow b$ \quad represents \quad  $a$ \textsl{genau dann, wenn} $b$
\end{enumerate}
