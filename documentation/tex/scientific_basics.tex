...
\begin{enumerate}
\item Cut Rule %TODO Die dinger übersetzen
\item Subsumption
\item Fallunterscheidung
\end{enumerate}

\subsection{Simplification with Cut Rule} %TODO die dinger übersetzen
...
The following sentence forms the basis for the principle of case differentiation. %TODO Satz übersetzen
