...
\newcommand{\dhbwabstractde}{
    Diese Arbeit befasst sich mit der erstellung einer Animation vom Davis \& Putnam Algoritmusses beim lösen des N-Damen Probles in JavaScript. Zuerst werden die wissenschaftlichen Grundlagen, die für das Verständnis des Algoritmusses und dem genannten Problem benötigt werden, vermittelt. Dazu kommen noch ein paar Technische Grundlagen, die für die Implemention in JavaScript relevant sind. Nachdem alle Grundlagen bekannt sind wird zuerst ein Konzept erstellt, welches dann bei der Implemention befolgt wird. Das Ergebnis der Implemention wird zum Schluss zu einem Schluss evaluiert und bezüglich möglicher Verbesserungen und anderen Verwendungen betrachtet.
} %TODO
